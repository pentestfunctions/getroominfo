...
def make_request(cookie_str):
    ...
    print(f"Retrieving current room details.... Please be patient")
    try:
...
# If user is in multiple rooms... Can't be bothered adding an actual fix, close your fkn rooms.
if data:
    for item in data:
        ...
        questions = driver.find_elements_by_css_selector('.room-task-question-details')
        answer_inputs = driver.find_elements_by_css_selector('.room-task-input-questions .form-control.room-answer-field')
